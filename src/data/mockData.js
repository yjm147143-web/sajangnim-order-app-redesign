...
(function () {
  ...
  function buildSeed() {
    ...
    const stores = [
      {
        ...
        minOrderAmountEnabled: false, minOrderAmount: 10000, minOrderBrandControlled: false,
        ...
        statusChangedAt: minutesAgo(180), todayFirstOpenAt: minutesAgo(180), networkStatus: 'ONLINE', ownerName: '김사장', ownerPhone: '01012345678',
        cashSalesAmount: 84000, cashOrderCount: 6,
        todaySalesAmount: 612000, totalSalesAmount: 5480000, todayOrderCount: 58, totalOrderCount: 519,
        salesStats: {
      ...
      { id: 'store-2', eventId: 'event-1', name: '고로케 트럭', operatingStatus: 'OPEN', autoAcceptOrders: true, guideDisplayMode: 'queue', cookTimeBase: 8, cookTimeMarginal: 1, cookTimeBatch: 8, cookHasHelper: true, cookHelperCount: 1, cookBufferMinutes: 2, statusChangedAt: minutesAgo(240), todayFirstOpenAt: minutesAgo(240), networkStatus: 'ONLINE', ownerName: '정사장', ownerPhone: '01022223333', cashSalesAmount: 156000, cashOrderCount: 11, todaySalesAmount: 470000, totalSalesAmount: 4700000, todayOrderCount: 62, totalOrderCount: 620, yesterdaySalesAmount: 431000, topMenuName: '수제 고로케', topMenuQty: 88 },
      { id: 'store-3', eventId: 'event-1', name: '타코야끼 부스', operatingStatus: 'OPEN', autoAcceptOrders: false, guideDisplayMode: 'time', cookTimeBase: 6, cookTimeMarginal: 1, cookTimeBatch: 12, cookHasHelper: false, cookHelperCount: 1, cookBufferMinutes: 1, statusChangedAt: minutesAgo(200), todayFirstOpenAt: minutesAgo(200), networkStatus: 'OFFLINE', ownerName: '한사장', ownerPhone: '01044445555', cashSalesAmount: 32000, cashOrderCount: 3, todaySalesAmount: 312000, totalSalesAmount: 2100000, todayOrderCount: 41, totalOrderCount: 276, yesterdaySalesAmount: 289000, topMenuName: '타코야끼 8알', topMenuQty: 64 },
      { id: 'store-4', eventId: 'event-1', name: '크래프트비어 하우스', operatingStatus: 'OPEN', autoAcceptOrders: false, guideDisplayMode: 'time', cookTimeBase: 5, cookTimeMarginal: 1, cookTimeBatch: 4, cookHasHelper: false, cookHelperCount: 1, cookBufferMinutes: 2, statusChangedAt: minutesAgo(95), todayFirstOpenAt: minutesAgo(95), networkStatus: 'ONLINE', lastOrderAt: minutesAgo(95), ownerName: '윤사장', ownerPhone: '01055556666', cashSalesAmount: 210000, cashOrderCount: 9, todaySalesAmount: 588000, totalSalesAmount: 3300000, todayOrderCount: 38, totalOrderCount: 213, yesterdaySalesAmount: 602000, topMenuName: 'IPA 생맥주', topMenuQty: 52 },
      { id: 'store-5', eventId: 'event-1', name: '떡볶이 포차', operatingStatus: 'CLOSED', autoAcceptOrders: true, guideDisplayMode: 'queue', cookTimeBase: 10, cookTimeMarginal: 2, cookTimeBatch: 6, cookHasHelper: false, cookHelperCount: 1, cookBufferMinutes: 2, statusChangedAt: minutesAgo(45), todayFirstOpenAt: minutesAgo(300), networkStatus: 'ONLINE', ownerName: '서사장', ownerPhone: '01066667777', cashSalesAmount: 40000, cashOrderCount: 4, todaySalesAmount: 198000, totalSalesAmount: 1500000, todayOrderCount: 25, totalOrderCount: 189, yesterdaySalesAmount: 245000, topMenuName: '즉석 떡볶이', topMenuQty: 45 },
      { id: 'store-6', eventId: 'event-1', name: '핫도그 트럭', operatingStatus: 'PAUSED', autoAcceptOrders: false, guideDisplayMode: 'time', cookTimeBase: 7, cookTimeMarginal: 2, cookTimeBatch: 5, cookHasHelper: false, cookHelperCount: 1, cookBufferMinutes: 3, statusChangedAt: minutesAgo(15), todayFirstOpenAt: minutesAgo(280), networkStatus: 'ONLINE', ownerName: '문사장', ownerPhone: '01077778888', cashSalesAmount: 18000, cashOrderCount: 2, todaySalesAmount: 122000, totalSalesAmount: 980000, todayOrderCount: 16, totalOrderCount: 129, yesterdaySalesAmount: 134000, topMenuName: '치즈 핫도그', topMenuQty: 21 },
    ];
    ...
    const menuItems = [
      ...
      { id: 'menu-4', storeId: 'store-1', categoryId: 'cat-2', name: '레모네이드', price: 5000, description: '상큼한 생레몬 에이드', imageUrl: '', origin: '국내산 레몬', nutritionInfo: '', allergyInfo: '', stockQuantity: 25, autoSoldoutEnabled: false, soldOut: false, exposed: true, sortOrder: 1, promoType: null, optionGroupIds: ['og-2'] },
    ...
    const orders = [
      ...
      { id: 'order-8', storeId: 'store-1', paymentOrderNo: 'PG-820150', pickupNo: '1000', channel: 'TABLET', paymentMethod: '카드', amount: 4500, items: items([{ menuName: '아메리카노', optionNames: [], quantity: 1 }]), customerContact: '01000000000', orderedAt: minutesAgo(60), acceptedAt: null, doneAt: minutesAgo(58), status: 'DONE', called: false, calledCount: 0, completeCount: 0, canceled: true, cancelReason: '손님 요청', cancelType: 'CANCEL', isReservation: false, reservationTime: null, customerNote: null },
    ];
